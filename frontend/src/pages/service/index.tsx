...
//   - Route: /service
//   - Data: custom_pages (module_key="service") => meta override
//   - i18n: site_settings.ui_services
// =============================================================
...
const SERVICE_MODULE_KEY = "service"; // sende "services" ise burada değiştir
...
const ServicePage: React.FC = () => {
  ...
  const titleFallback = bannerTitle;
