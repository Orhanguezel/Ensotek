...
const KvkkPage: React.FC = () => {
  ...
  // -----------------------------
  const { data: kvkkData } = useListCustomPagesPublicQuery({
    module_key: 'kvkk',
    locale,
    limit: 10,
    sort: 'created_at',
  ...
  const pageDescRaw = useMemo(() => {
    ...
    const fromUiDesc = String(ui('ui_kvkk_page_description', '') || '').trim();
    ...
    return 'Ensotek KVKK bilgilendirmesi: kişisel verilerin işlenmesi, hukuki sebepler, güvenlik önlemleri ve başvuru hakları.';
  }, [ui, primary, seo]);
