...
const ProductPage: React.FC = () => {
  ...
  // --- SEO fields (list page) ---
  const pageTitleRaw = useMemo(() => {
    // İstersen ayrı bir key ekleyebilirsin: ui_products_meta_title
    // Şimdilik bannerTitle iyi default.
    return String(
      ui("ui_products_meta_title", String(bannerTitle)),
    ).trim();
  }, [ui, bannerTitle]);

  const pageDescRaw = useMemo(() => {
    // İstersen ayrı bir key ekleyebilirsin: ui_products_meta_description
