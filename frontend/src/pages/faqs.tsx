...
const FaqsPage: React.FC = () => {
  ...
  // Banner title (UI)
  const bannerTitle = ui('ui_faqs_page_title', locale === 'de' ? 'Sıkça Sorulan Sorular' : 'FAQs');
  ...
  const titleFallback = ui(
    'ui_faqs_page_title',
    locale === 'de' ? 'Sıkça Sorulan Sorular' : 'FAQs',
  );
  ...
  const pageDescRaw =
    String(
      ui('ui_faqs_meta_description', ui('ui_faqs_page_description', descFallback)) || '',
    ).trim() ||
