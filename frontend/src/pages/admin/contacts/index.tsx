...
// Ensotek – Admin Contact Mesajları (Liste + filtreler + edit modal)
// =============================================================
...
const ContactAdminPage: React.FC = () => {
  ...
  const [orderBy, setOrderBy] =
    useState<"created_at" | "updated_at" | "status" | "name">(
      "created_at",
    );
  ...
  const {
    ...
    isFetching,
    refetch,
  } = useListContactsAdminQuery(listParams);
  ...
  const [formState, setFormState] = useState<ContactFormState | null>(
    null,
  );
  ...
  const handleToggleResolved = async (
    ...
    try {
      ...
      setRows((prev) =>
        prev.map((r) =>
          r.id === item.id ? { ...r, is_resolved: value } : r,
        ),
      );
    } catch (err: any) {
      const msg =
                ...
                <div className="modal-body">
                    ...
                    <div className="col-md-4 d-flex align-items-end">
                      <div className="form-check form-switch small">
                        ...
                        <label
                          ...
                          htmlFor="contact-modal-resolved"
                        >
                          Çözüldü
                        </label>
                      </div>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="form-text small">
                      Bu not sadece admin panelde görünür, kullanıcıya
                      gönderilmez.
                    </div>
                  </div>
                </div>
