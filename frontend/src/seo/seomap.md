...
## 2) Yapılacak işler → Ensotek’te “uygulanabilir” teknik kontrol listesi
...
## 3) Ensotek için kritik mimari not (hardcode’suz yönetim)
...
* Ya da projeyi buraya zip olarak ekle (ensotek.zip varsa zaten bende; “hangi klasör” bilgisini verince doğrudan ilgili dosyalardan patch planı çıkarırım)
