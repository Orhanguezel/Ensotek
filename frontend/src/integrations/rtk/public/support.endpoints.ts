...
export const supportApi = baseApi.injectEndpoints({
  endpoints: (build) => ({
    // -------- TICKETS: LIST (PUBLIC) --------
    // GET /support_tickets
    listSupportTickets: build.query<SupportTicketListResponse, SupportTicketListQueryParams | void>(
      {
        ...
        transformResponse: (response: SupportTicketDto[], meta): SupportTicketListResponse => {
    ...
    createSupportTicket: build.mutation<SupportTicketDto, SupportTicketCreatePayload>({
      query: (body) => ({
        url: '/support_tickets',
        method: 'POST',
        body,
