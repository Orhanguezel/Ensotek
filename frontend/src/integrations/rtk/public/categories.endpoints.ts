...
import type { CategoryDto, CategoryPublicListQueryParams } from '@/integrations/types';
...
export const categoriesApi = baseApi.injectEndpoints({
  endpoints: (build) => ({
    ...
    /* --------------------------------------------------------- */
    listCategories: build.query<CategoryDto[], CategoryPublicListQueryParams | void>({
      query: (params) => ({
        url: '/categories',
        method: 'GET',
