// =============================================================
// FILE: src/components/containers/sparepart/SparepartMore.tsx
// Ensotek – More Spareparts Section (detail page altı)
//   - Data: products (category: sparepart)
//   - Mevcut slug haricindeki yedek parçalar
...
const SparepartMore: React.FC = () => {
  ...
  const moreTitle = ui(
    "ui_spareparts_more_title",
    locale === "tr" ? "Diğer Yedek Parçalar" : "More Spare Parts",
  );
