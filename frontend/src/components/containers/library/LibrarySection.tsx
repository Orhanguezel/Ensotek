// =============================================================
// FILE: src/components/containers/library/LibrarySection.tsx
// Ensotek – Library Preview Section (first 2 items)
//   - Kullanım: Anasayfa vb. kısa preview alanları
// =============================================================
...
const LibrarySection: React.FC = () => {
    ...
    // Preview için sadece ilk 2 içerik
    const { data = [], isLoading } = useListLibraryQuery({
        locale,
        limit: 2, // 🔥 Preview: 2 kayıt
    ...
    const items = useMemo(() => {
        ...
        // Güvenli olsun diye yine ilk 2’yi alıyoruz
        ...
        <section className="features__area p-relative features-bg pt-120 pb-35 cus-faq">
            ...
            <div className="container">
                <div className="row" data-aos="fade-up" data-aos-delay="300">
                    ...
                    {/* Sağ içerik – 2 kayıtlık akordeon */}
                    <div className="col-xl-6 col-lg-6">
