    ...
    () => [
      {
        ...
        title: ui(
          ...
          locale === 'de' ? 'Sanayi referansımız' : 'Industrial references',
        ),
        label: ui(
          'ui_about_stats_refs_label',
          locale === 'de' ? 'Referans müşteri & tesis' : 'Reference customers & plants',
        ),
      },
      {
        id: 'projects',
        ...
        title: ui(
          ...
          locale === 'de' ? 'Tamamlanan proje' : 'Completed projects',
        ),
        label: ui(
          'ui_about_stats_projects_label',
          locale === 'de' ? 'Yurtiçi ve yurtdışı projeler' : 'Domestic and international projects',
        ),
      },
      {
        id: 'years',
        ...
        title: ui(
          ...
          locale === 'de' ? 'Yıllık tecrübe' : 'Years of experience',
        ),
        label: ui(
          'ui_about_stats_years_label',
          locale === 'de' ? 'Su soğutma ve proses soğutma' : 'Cooling tower & process cooling',
        ),
      },
    ],
    [ui, locale],
