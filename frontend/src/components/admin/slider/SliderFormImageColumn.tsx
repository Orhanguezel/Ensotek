...
// Ensotek – Slider Form Sağ Kolon (Storage + Preview)
// =============================================================
...
/**
 * Storage metadata – diğer modüllerle aynı pattern:
 * - module_key (slider)
 * - locale
 * - slider_slug
 * - slider_id
...
export const SliderFormImageColumn: React.FC<SliderFormImageColumnProps> = ({
  ...
  // AdminImageUploadField metadata tipi: Record<string, string | number | boolean>
  ...
  return (
    <AdminImageUploadField
      ...
      helperText={
        <>
          Storage modülü üzerinden slider için bir görsel yükleyebilirsin.
          Yüklenen görselin URL&apos;i sol taraftaki{" "}
          <strong>Görsel URL (image_url)</strong> alanına otomatik yazılır
