...
// Ensotek – FAQ Form – JSON mod alanı
// =============================================================
...
export const FaqsFormJsonSection: React.FC<
  FaqsFormJsonSectionProps
> = ({ jsonModel, disabled, onChangeJson, onErrorChange }) => {
  return (
    <AdminJsonEditor
      ...
      helperText={
        <>
          Bu JSON, <code>/admin/faqs</code> create / update
          isteklerine gönderilen payload ile uyumludur. Başlıca
          alanlar:
          <ul className="mb-0 mt-1">
            <li>
              <code>question</code>, <code>answer</code>,{" "}
              <code>slug</code>, <code>locale</code>
            </li>
            <li>
              <code>is_active</code>, <code>display_order</code>
            </li>
            <li>
              <code>category_id</code>, <code>sub_category_id</code>{" "}
              (opsiyonel)
            </li>
          </ul>
        </>
