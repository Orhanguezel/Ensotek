// =============================================================
// FILE: src/components/admin/services/ServicesHeader.tsx (FIXED)
// Ensotek – Admin Services Header (filters + locale + summary)
// - Statik locale map YOK
// - Locales parent'tan gelir
// - Category/SubCategory RTK hooks ONLY from "@/integrations/rtk/hooks"
// =============================================================
...
export const ServicesHeader: React.FC<ServicesHeaderProps> = ({
  ...
  const subCategoryQueryParams = useMemo(
    ...
    [effectiveLocale, filters.category_id],
  );
  ...
  const subCategoriesDisabled = loading || isSubCategoriesLoading || !filters.category_id;
        ...
        <div className="d-flex flex-column flex-lg-row justify-content-between gap-3">
          <div style={{ minWidth: 0, flex: 2 }}>
            <div className="d-flex justify-content-between align-items-center mb-2">
              <div>
                ...
                <div className="text-muted small">
                  Ensotek endüstriyel soğutma kulesi hizmetlerini yönet.
                </div>
              </div>
            ...
            <div className="row g-2 align-items-end">
              ...
              <div className="col-sm-6 col-md-3">
                <label className="form-label small mb-1">Kategori (Hizmet)</label>
                <select
              ...
              <div className="col-sm-6 col-md-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    onChangeFilters({ sub_category_id: e.target.value || undefined })
                  }
