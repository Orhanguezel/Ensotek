...
export const SubCategoryFormImageColumn: React.FC<
  SubCategoryFormImageColumnProps
> = ({ metadata, iconValue, disabled, onIconChange }) => {
  ...
  return (
    <AdminImageUploadField
      ...
      helperText={
        <>
          Storage modülü üzerinden alt kategori için bir görsel
          yükleyebilirsin. Yüklenen görselin URL&apos;i formdaki{" "}
          <strong>Icon / Görsel URL</strong> alanına otomatik
          yazılabilir ve JSON modeline yansıtılabilir.
        </>
      }
      bucket="public"
