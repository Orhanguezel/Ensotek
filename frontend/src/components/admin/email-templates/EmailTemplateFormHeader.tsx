// ===================================================================
// FILE: src/components/admin/email-templates/EmailTemplateListFormHeader.tsx
...
export const EmailTemplateFormHeader: React.FC<
  EmailTemplateFormHeaderProps
> = ({
  mode,
  values,
  onChange,
          ...
          <div className="row g-2 align-items-end">
            ...
            <div className="col-md-5">
              ...
              <div className="form-text small">
                Backend`de <code>template_key</code> parent kayıt için
                tekildir. Farklı diller aynı key`i paylaşır.
              </div>
            </div>
              ...
              <div className="row g-2">
                <div className="col-7">
                  ...
                  <select
                    ...
                    disabled={loading && !localeOptions.length}
                  >
                    {localeOptions.length === 0 && (
                      <option value="">Locale seç</option>
                    )}
                  ...
                  <div className="form-text small">
                    Her locale için ayrı çeviri kaydı tutulur.
                  </div>
                </div>
                ...
                <div className="small text-muted">
                  <div>
                    ...
                    <span className="fw-semibold">
                      {formatDate(values.parentCreatedAt)}
                    </span>
                  </div>
                  <div>
                    Parent güncelleme:{" "}
                    <span className="fw-semibold">
                      {formatDate(values.parentUpdatedAt)}
                    </span>
                  </div>
                  {values.translationCreatedAt && (
                    <div>
                      ...
                      <span className="fw-semibold">
                        {formatDate(values.translationCreatedAt)}
                      </span>
                    </div>
                  )}
                  {values.translationUpdatedAt && (
                    <div>
                      ...
                      <span className="fw-semibold">
                        {formatDate(values.translationUpdatedAt)}
                      </span>
                    </div>
                  )}
                </div>
