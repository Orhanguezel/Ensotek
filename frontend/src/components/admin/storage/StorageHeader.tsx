...
// Ensotek – Storage Header + Filtreler
// =============================================================
    ...
    <div className="row mb-3">
      ...
      <div className="col-12 col-lg-6 mb-2 mb-lg-0">
        ...
        <p className="text-muted small mb-0">
          Storage modülündeki dosyaları listeleyip; bucket, modül klasörü ve
          MIME türüne göre filtreleyebilir, tekli veya çoklu yükleme
          yapabilirsin.
        </p>
        ...
        <div className="d-flex flex-wrap gap-2 small">
          ...
          <div className="input-group input-group-sm" style={{ maxWidth: 260 }}>
            ...
            <select
              ...
              value={sort}
              onChange={(e) =>
                onSortChange(e.target.value as "created_at" | "name" | "size")
              }
            >
