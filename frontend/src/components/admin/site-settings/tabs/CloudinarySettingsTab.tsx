...
export const CloudinarySettingsTab: React.FC<CloudinarySettingsTabProps> = ({
  locale,
}) => {
  const {
    data: settings,
  ...
  const handleSave = async () => {
    try {
      ...
      const msg =
        ...
        err?.message ||
        "Storage ayarları kaydedilirken bir hata oluştu.";
      toast.error(msg);
    }
  };
        ...
        <div className="row g-3">
          ...
          <div className="col-md-4">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("storage_local_root", e.target.value)
              }
          ...
          <div className="col-md-4">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("storage_local_base_url", e.target.value)
              }
          ...
          <div className="col-md-6">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("storage_cdn_public_base", e.target.value)
              }
              placeholder="https://cdn.ensotek.com"
            />
          </div>
          ...
          <div className="col-md-6">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("storage_public_api_base", e.target.value)
              }
              placeholder="https://api.ensotek.com"
            />
          </div>
          ...
          <div className="col-md-4">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("cloudinary_api_key", e.target.value)
              }
              placeholder="API key"
            />
          </div>
          ...
          <div className="col-md-4">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("cloudinary_api_secret", e.target.value)
              }
          ...
          <div className="col-md-6">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("cloudinary_folder", e.target.value)
              }
              placeholder="uploads"
            />
          </div>
          ...
          <div className="col-md-6">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("cloudinary_unsigned_preset", e.target.value)
              }
