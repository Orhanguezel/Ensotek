...
// Ensotek – Brand / Media Settings Tab (GLOBAL '*')
...
export const BrandMediaTab: React.FC = () => {
  ...
  return (
    <div className="card ensotek-brand-media">
      ...
      <div className="card-body">
        ...
        <div className="ensotek-brand-media__grid">
          {SITE_MEDIA_KEYS.map((k) => {
            ...
            return (
              <div key={`media_${k}`} className="ensotek-brand-media__item">
                <div className="ensotek-brand-media__head">
                  <div>
                    <div className="ensotek-brand-media__title">{labelMap[k]}</div>
                    <div className="ensotek-brand-media__meta">
                      <span className="font-monospace">{k}</span>
                      <span className="text-muted">locale: *</span>
                    </div>
                  </div>

                  <div className="ensotek-brand-media__actions">
                    <Link
                ...
                <div className="ensotek-brand-media__body">
                  <div className="ensotek-brand-media__uploader">
                ...
                {rawUrl ? (
                  <div className="ensotek-brand-media__url">
                    <span className="text-muted small">URL:</span>

                    <code className="ensotek-brand-media__urlCode" title={rawUrl}>
                      {rawUrl}
                    </code>
