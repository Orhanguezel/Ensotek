-- =============================================================
-- FILE: 014.7_product_bbbb0002_en.sql (FINAL)
...
-- -------------------------
-- REVIEWS (EN) — ID bazlı reset (locale yok)
-- -------------------------
...
-- -------------------------
-- OPTIONS (EN) — ID bazlı reset (locale yok)
-- -------------------------
