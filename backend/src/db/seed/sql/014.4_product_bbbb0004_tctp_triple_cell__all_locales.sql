...
VALUES (
  ...
  0.00,
  'http://localhost:8086/uploads/product/open-circuit-tctp-triple-1-250x250-1.png',
  NULL,
  JSON_ARRAY(
    'http://localhost:8086/uploads/material/open-circuit-tctp-triple-1-250x250-1.jpg',
    'http://localhost:8086/uploads/material/open-circuit-tctp-triple-2-250x250-1.jpg',
    'http://localhost:8086/uploads/material/open-circuit-tctp-triple-3-250x250-1.jpg'
  ),
  JSON_ARRAY(),
  1,
  1,
