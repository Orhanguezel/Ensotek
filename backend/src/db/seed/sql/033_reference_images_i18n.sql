...
VALUES
(UUID(), @REFIMG_TORONTO_A_ID, 'tr', 'Toronto galeri görseli 1', NULL, NOW(3), NOW(3))
...
(id, image_id, locale, alt, caption, created_at, updated_at)
VALUES
(UUID(), @REFIMG_TORONTO_B_ID, 'tr', 'Toronto galeri görseli 2', NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 alt       = VALUES(alt),
 caption   = VALUES(caption),
 updated_at= VALUES(updated_at);
...
(id, image_id, locale, alt, caption, created_at, updated_at)
VALUES
(UUID(), @REFIMG_ECOM_A_ID, 'tr', 'E-ticaret galeri görseli', NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 alt       = VALUES(alt),
 caption   = VALUES(caption),
 updated_at= VALUES(updated_at);
...
(id, image_id, locale, alt, caption, created_at, updated_at)
VALUES
(UUID(), @REFIMG_TORONTO_A_ID, 'en', 'Toronto gallery image 1', NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 alt       = VALUES(alt),
 caption   = VALUES(caption),
 updated_at= VALUES(updated_at);
...
(id, image_id, locale, alt, caption, created_at, updated_at)
VALUES
(UUID(), @REFIMG_TORONTO_B_ID, 'en', 'Toronto gallery image 2', NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 alt       = VALUES(alt),
 caption   = VALUES(caption),
 updated_at= VALUES(updated_at);
...
(id, image_id, locale, alt, caption, created_at, updated_at)
VALUES
(UUID(), @REFIMG_ECOM_A_ID, 'en', 'E-commerce gallery image', NULL, NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
 alt       = VALUES(alt),
 caption   = VALUES(caption),
 updated_at= VALUES(updated_at);
...
INSERT INTO reference_images_i18n
(id, image_id, locale, alt, caption, created_at, updated_at)
SELECT UUID(), s.image_id, 'en',
       s.alt, s.caption, NOW(3), NOW(3)
