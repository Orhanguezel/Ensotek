...
--   - Catalog CTA (src/components/containers/cta/CatalogCta.tsx)
--   - Public catalog request endpoint: useCreateCatalogRequestPublicMutation
-- =============================================================
...
(
  ...
  'tr',
  JSON_OBJECT(
    -- CTA (src/components/containers/cta/CatalogCta.tsx)
