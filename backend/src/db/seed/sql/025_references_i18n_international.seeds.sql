...
VALUES
  -- POWER
  (UUID(),'7b1b1001-2222-4222-8222-7b1b7b1b1001','tr','ENKA','enka-yurt-disi',
  ...
  (UUID(),'7b1b1001-2222-4222-8222-7b1b7b1b1002','tr','Tekfen','tekfen-yurt-disi',
  ...
  (UUID(),'7b1b1001-2222-4222-8222-7b1b7b1b1003','tr','Çalık Enerji','calik-enerji-yurt-disi',
  ...
  -- PETRO/CHEM
  (UUID(),'7b1b1002-2222-4222-8222-7b1b7b1b2001','tr','Şişecam','sisecam-yurt-disi',
  ...
  (UUID(),'7b1b1002-2222-4222-8222-7b1b7b1b2002','tr','SASA','sasa-yurt-disi',
  ...
  (UUID(),'7b1b1002-2222-4222-8222-7b1b7b1b2003','tr','Petkim','petkim-yurt-disi',
  ...
  -- CEMENT/MINING
  (UUID(),'7b1b1003-2222-4222-8222-7b1b7b1b3001','tr','Oyak Çimento','oyak-cimento-yurt-disi',
  ...
  (UUID(),'7b1b1003-2222-4222-8222-7b1b7b1b3002','tr','Limak','limak-yurt-disi',
  ...
  (UUID(),'7b1b1003-2222-4222-8222-7b1b7b1b3003','tr','Akçansa','akcansa-yurt-disi',
  ...
  -- FOOD/BEV
  (UUID(),'7b1b1004-2222-4222-8222-7b1b7b1b4001','tr','Ülker','ulker-yurt-disi',
  ...
  (UUID(),'7b1b1004-2222-4222-8222-7b1b7b1b4002','tr','Eti','eti-yurt-disi',
  ...
  (UUID(),'7b1b1004-2222-4222-8222-7b1b7b1b4003','tr','Sütaş','sutas-yurt-disi',
  ...
  -- STEEL/METAL
  (UUID(),'7b1b1005-2222-4222-8222-7b1b7b1b5001','tr','Erdemir','erdemir-yurt-disi',
  ...
  (UUID(),'7b1b1005-2222-4222-8222-7b1b7b1b5002','tr','Tosyalı','tosyali-yurt-disi',
  ...
  (UUID(),'7b1b1005-2222-4222-8222-7b1b7b1b5003','tr','İsdemir','isdemir-yurt-disi',
  ...
  -- AUTO
  (UUID(),'7b1b1006-2222-4222-8222-7b1b7b1b6001','tr','Ford Otosan','ford-otosan-yurt-disi',
  ...
  (UUID(),'7b1b1006-2222-4222-8222-7b1b7b1b6002','tr','Tofaş','tofas-yurt-disi',
  ...
  (UUID(),'7b1b1006-2222-4222-8222-7b1b7b1b6003','tr','Arçelik','arcelik-yurt-disi',
  ...
  -- MALL/COMMERCIAL
  (UUID(),'7b1b1007-2222-4222-8222-7b1b7b1b7001','tr','Rönesans','ronesans-yurt-disi',
  ...
  (UUID(),'7b1b1007-2222-4222-8222-7b1b7b1b7002','tr','ENKA İnşaat','enka-insaat-yurt-disi',
  ...
  (UUID(),'7b1b1007-2222-4222-8222-7b1b7b1b7003','tr','TAV Havalimanları','tav-yurt-disi',
  ...
  -- DC/HOSP
  (UUID(),'7b1b1008-2222-4222-8222-7b1b7b1b8001','tr','Turkcell','turkcell-yurt-disi',
  ...
  (UUID(),'7b1b1008-2222-4222-8222-7b1b7b1b8002','tr','Türk Telekom','turk-telekom-yurt-disi',
  ...
  (UUID(),'7b1b1008-2222-4222-8222-7b1b7b1b8003','tr','Acıbadem','acibadem-yurt-disi',
  ...
  -- OTHER
  (UUID(),'7b1b1009-2222-4222-8222-7b1b7b1b9001','tr','Türk Hava Yolları','thy-yurt-disi',
  ...
  (UUID(),'7b1b1009-2222-4222-8222-7b1b7b1b9002','tr','Aselsan','aselsan-yurt-disi',
  ...
  (UUID(),'7b1b1009-2222-4222-8222-7b1b7b1b9003','tr','Vestel','vestel-yurt-disi',
