...
-- -------------------------------------------------------------
-- SOĞUTMA KULELERİ: custom_page ID’leri (SENİN DB’NE GÖRE GÜNCELLEYEBİLİRSİN)
-- Bu ID’ler örnektir; custom_pages tablosunda hangi sayfalara bağlayacaksan
-- sadece bu 4 değişkeni gerçek ID’lerle değiştirmen yeterli.
-- -------------------------------------------------------------
SET @PAGE_COOLING_TOWERS        := '11111111-2222-3333-4444-555555555581'; -- /sogutma-kuleleri
SET @PAGE_COOLING_TOWER_TYPES   := '11111111-2222-3333-4444-555555555582'; -- /sogutma-kuleleri/tipler
SET @PAGE_COOLING_TOWER_MAINT   := '11111111-2222-3333-4444-555555555583'; -- /sogutma-kuleleri/bakim
SET @PAGE_COOLING_TOWER_PROJECT := '11111111-2222-3333-4444-555555555584'; -- /sogutma-kuleleri/referanslar
...
-- -------------------------------------------------------------
-- SOĞUTMA KULELERİ review parent’ları (yeni)
-- -------------------------------------------------------------
