// src/modules/references/validation.ts
// =============================================================
...
// 🧩 BURASI ÖNEMLİ: i18n alanları artık opsiyonel.
...
export const upsertReferenceBodySchema =
  upsertReferenceParentBodySchema.merge(upsertReferenceI18nBodySchema);
export type UpsertReferenceBody = z.infer<typeof upsertReferenceBodySchema>;

export const patchReferenceBodySchema =
  patchReferenceParentBodySchema.merge(patchReferenceI18nBodySchema);
...
export type UpsertReferenceImageParentBody = z.infer<
  typeof upsertReferenceImageParentBodySchema
>;

export const patchReferenceImageParentBodySchema =
  upsertReferenceImageParentBodySchema.partial();
export type PatchReferenceImageParentBody = z.infer<
  typeof patchReferenceImageParentBodySchema
>;
...
export type UpsertReferenceImageI18nBody = z.infer<
  typeof upsertReferenceImageI18nBodySchema
>;
...
export type PatchReferenceImageI18nBody = z.infer<
  typeof patchReferenceImageI18nBodySchema
>;

/* ============== GALLERY: COMBINED ============== */
export const upsertReferenceImageBodySchema =
  upsertReferenceImageParentBodySchema.merge(
    upsertReferenceImageI18nBodySchema,
  );
export type UpsertReferenceImageBody = z.infer<
  typeof upsertReferenceImageBodySchema
>;

export const patchReferenceImageBodySchema =
  patchReferenceImageParentBodySchema.merge(
    patchReferenceImageI18nBodySchema,
  );
export type PatchReferenceImageBody = z.infer<
  typeof patchReferenceImageBodySchema
>;
