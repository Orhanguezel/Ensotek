...
export const validateCreateCompany = [
  ...
  // ⚠️ logoUrl zorunlu değil, image middleware’den geliyor → validasyonu burada yapmıyoruz
  validateRequest,
];
...
export const validateUpdateCompany = [
  ...
  // ⚠️ logoUrl optional → image middleware’den geliyor, burada text tipini kontrol etmiyoruz
  validateRequest,
];
