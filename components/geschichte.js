        ...
        <section id="geschichte-section">
            ...
            <div class="geschichte-container">
                <div class="geschichte-text">
                    <h4>Ensotek Su Soğutma Kuleleri A.Ş. hat eine tiefe Expertise und Innovationsgeschichte, die bis ins Jahr 1986 zurückreicht...</h4>
                </div>
                <div class="geschichte-image">
                    <img src="img/all/cover_1.jpg" alt="Team" class="img-fluid rounded"> <!-- Görsel -->
                </div>
            </div>
        </section>
    `;
