export function loadAktivit() {
    ...
    aktivitSection.innerHTML = `
      <section id="Aktivit">
        ...
        <h2>Ensotek bietet eine breite Palette von Aktivitäten im Bereich industrieller Wasser-Kühltürme und zugehöriger Dienstleistungen. Unser Ziel ist es, unseren Kunden hochwertige Produkte, zuverlässige Dienstleistungen und professionellen Ingenieurservice zu bieten.</h2>
        <div class="akt">
