...
- [x] **TR11 · P2 · ensotek_com_tr / frontend / hero · Kullanıcı isteği 11 Eylül — Hero'da gerçek ürünlerin gösterilmesi (MOE ile aynı yaklaşım)** Sağ kolonda farklı kategorilerden 3 kule kartı, "N ürünün tümünü gör", kategori çipleri ve yedek parça bağlantısı; sunucu bileşeni, ilk görsel LCP öncelikli. **11 Eylül kabulü:** EN/TR × masaüstü/mobil canlı kabul geçti; mobil Lighthouse 94/95, A11y/BP/SEO 100; rollback `.next.before-checklist-20260911T170554Z`. Ürün/marka adı koddan gelmez. [Kanıt](output/checklist-2026-09-11-tr-hero/README.md). **Ek (11 Eylül):** tek hücreli CTP ürününün TR/DE slug ve alt metni DB+seed'de düzeltildi; ürün detayında yabancı slug 308, eski adres yeni slug'a yönlenir. [Kanıt](output/checklist-2026-09-11-tr-product-slug/README.md).
