...
| [analiz/02-ihtiyac-listesi.md](analiz/02-ihtiyac-listesi.md) | **173 gereksinim**, 21 modül, her biri kaynağına bağlı |
| [analiz/03-kapsam-taslagi.md](analiz/03-kapsam-taslagi.md) | **SCOPE v0.2** — 21 modül, 6 faz (0–5), bağımlılık zinciri, sistem ne DEĞİL |
...
| **3** | MOD-09 Üretim · MOD-10 Kalite · MOD-11 Sevkiyat · **MOD-15 Navlun** | İş emri ve evrak darboğazı |
...
|---|---|
| **transpalet-crm** (48 modül) | Üretim emri, reçete, stok, satın alma, tedarikçi, sevkiyat, mal kabul, teklif, müşteri, servis, personel, görev, gantt, Logo entegrasyonu |
| **paspas** (Paspas ERP, 41 modül) | Üretim emirleri, reçeteler, satış siparişleri, vardiya analizi, makine havuzu |
| **ihracatradari.com.tr** | Teklif+revizyon+proforma, **packing list**, **navlun + incoterm**, onay motoru, ondalık güvenli hesap, **firma bulma** (enrichment, decision-makers, scoring) |
